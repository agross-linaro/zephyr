...
static unsigned char pl011_poll_out(struct device *dev,
					     unsigned char c)
{
...
static struct uart_device_config pl011_cfg_port_0 = {
	.base = (u8_t *)PL011_PORT0_BASE_ADDRESS,
...
static struct pl011_data pl011_data_port_0 = {
	.baud_rate = CONFIG_UART_PL011_PORT0_BAUD_RATE,
};

DEVICE_AND_API_INIT(pl011_port_0,
		    CONFIG_UART_PL011_PORT0_NAME,
		    &pl011_init,
		    &pl011_data_port_0,
...
static void pl011_irq_config_func_0(struct device *dev)
{
	IRQ_CONNECT(PL011_PORT0_IRQ_TX,
		    CONFIG_UART_PL011_PORT0_IRQ_PRI,
		    pl011_isr,
		    DEVICE_GET(pl011_port_0),
		    0);
	irq_enable(PL011_PORT0_IRQ_TX);

	IRQ_CONNECT(PL011_PORT0_IRQ_RX,
		    CONFIG_UART_PL011_PORT0_IRQ_PRI,
		    pl011_isr,
		    DEVICE_GET(pl011_port_0),
		    0);
	irq_enable(PL011_PORT0_IRQ_RX);

	IRQ_CONNECT(PL011_PORT0_IRQ_RXTIM,
		    CONFIG_UART_PL011_PORT0_IRQ_PRI,
		    pl011_isr,
		    DEVICE_GET(pl011_port_0),
		    0);
	irq_enable(PL011_PORT0_IRQ_RXTIM);
}
#endif
...
static struct uart_device_config pl011_cfg_port_1 = {
	.base = (u8_t *)PL011_PORT1_BASE_ADDRESS,
	.sys_clk_freq = CONFIG_SYS_CLOCK_HW_CYCLES_PER_SEC,
#ifdef CONFIG_UART_INTERRUPT_DRIVEN
...
static struct pl011_data pl011_data_port_1 = {
	.baud_rate = CONFIG_UART_PL011_PORT1_BAUD_RATE,
};

DEVICE_AND_API_INIT(pl011_port_1,
		    CONFIG_UART_PL011_PORT1_NAME,
		    &pl011_init,
		    &pl011_data_port_1,
...
static void pl011_irq_config_func_1(struct device *dev)
{
	IRQ_CONNECT(PL011_PORT1_IRQ_TX,
		    CONFIG_UART_PL011_PORT1_IRQ_PRI,
		    pl011_isr,
		    DEVICE_GET(pl011_port_1),
		    0);
	irq_enable(PL011_PORT1_IRQ_TX);

	IRQ_CONNECT(PL011_PORT1_IRQ_RX,
		    CONFIG_UART_PL011_PORT1_IRQ_PRI,
		    pl011_isr,
		    DEVICE_GET(pl011_port_1),
		    0);
	irq_enable(PL011_PORT1_IRQ_RX);

	IRQ_CONNECT(PL011_PORT1_IRQ_RXTIM,
		    CONFIG_UART_PL011_PORT1_IRQ_PRI,
		    pl011_isr,
		    DEVICE_GET(pl011_port_1),
		    0);
	irq_enable(PL011_PORT1_IRQ_RXTIM);
}
#endif
